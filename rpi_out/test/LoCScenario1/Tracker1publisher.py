...
if __name__ == "__main__":
    ...
    node = Node(node_name='sensors.TCRT5000', connection_params=conn_params, heartbeats=False)
    pub = node.create_publisher(msg_type=TrackerMessage, topic="scenario1.sensor.tracker.tracker1")
    node.run()
    msg = TrackerMessage()
    sample(msg = msg)
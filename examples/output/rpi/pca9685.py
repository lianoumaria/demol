...
CHANNEL = 0 
INITIAL_ANGLE = 0  # Initial angle for the servo
FINAL_ANGLE = 180  # Final angle for the servo
ANGULAR_SPEED = 0.1  # Speed of the servo movement in degrees per second
